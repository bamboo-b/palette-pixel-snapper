...
Snap messy or AI-generated pixel art to a perfect grid — and repaint it with **your own palette**.

Built on [Sprite Fusion Pixel Snapper](https://github.com/Hugo-Dz/spritefusion-pixel-snapper)'s grid-snapping core, this fork adds full palette control: feed it a palette and every pixel is matched to it, perceptually.
